...
class OrganizersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organizer" do
    assert_difference('Organizer.count') do
      post organizers_url, params: { organizer: { microcosm_id: @organizer.microcosm_id, user_id: @organizer.user_id } }
    end
  ...
  test "should update organizer" do
    patch organizer_url(@organizer), params: { organizer: { microcosm_id: @organizer.microcosm_id, user_id: @organizer.user_id } }
