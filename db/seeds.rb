Microcosm.create!([
  {name: "MappingDC", key: "mdc", members_num: 1, facebook: "mappingdc", twitter: "mappingdc", lat: 38.9, lon: -77.03, min_lat: 38.516 * 10**7, max_lat: 39.472 * 10**7, min_lon: -77.671 * 10**7, max_lon: -76.349 * 10**7}
])
Event.create!([
...
MicrocosmChangeset.create!([
  {microcosm_id: 1, changeset_id: 56625888, user_id: 791438, editor_id: 1, review_num: 0}
])
